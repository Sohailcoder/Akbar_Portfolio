...
function Projects3() {
  ...
  return (
    ...
    className='text-4xl mt-5 text-center font-semibold'> Projects</motion.h1>
    <motion.div 
      ...
      className="card__container grid gap-14 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
        {cards.map((card, index) => (
            ...
            <motion.img
              ...
              />
            <div className="card__data p-4 text-center bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 rounded-b-lg">
              <h2 className="card__title text-[1.5rem] font-medium text-white mb-3">
                {card.title}
              </h2>
              <h2 className="card__title text-[1.5rem] font-medium text-white mb-3">
                {card.title2}
